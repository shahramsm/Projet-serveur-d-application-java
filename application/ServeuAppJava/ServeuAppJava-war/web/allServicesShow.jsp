        ...
        <div class="container">
            <div class="card" style=" margin-bottom: 20px;">
                <div class="card-header"> 
                            Toutes les offres et les demandes de services
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test = "${c.etat == 'VALIDE' }"> 
                                             ...
                                             <center>
                                                ...
                                                <a href="ServiceShowDetails?id=${c.id}" class="btn btn-primary"> <i class="	fa fa-eye" aria-hidden="true"></i> </a>
